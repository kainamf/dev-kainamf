...
import { Code2, Globe, Layers, ArrowRight, Github, Instagram, Monitor, Smartphone, Zap, Palette, Rocket, Star } from 'lucide-react';
                ...
                <div className="w-full max-w-6xl">
                    ...
                    <div className="text-center mb-16 relative">
                        ...
                        <div className="inline-flex items-center gap-2 bg-[#212328] px-6 py-3 rounded-full border border-[#7CDA3D]/30 mb-8">
                            <Rocket size={20} className="text-[#7CDA3D] animate-spin" />
                    ...
                    <div className="bg-gradient-to-r from-[#212328] to-[#212328]/80 rounded-3xl p-12 mb-12 relative overflow-hidden border border-[#7CDA3D]/20 hover:border-[#7CDA3D]/50 transition-all duration-500 group">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center">
                                <button className="group/btn bg-[#7CDA3D] text-[#030303] px-10 py-4 rounded-2xl font-bold text-lg hover:bg-[#7CDA3D]/90 transition-all duration-300 flex items-center justify-center gap-3 hover:scale-105 hover:shadow-2xl hover:shadow-[#7CDA3D]/30 relative overflow-hidden">
                                ...
                                <button className="border-2 border-[#7CDA3D] text-[#7CDA3D] px-10 py-4 rounded-2xl font-bold text-lg hover:bg-[#7CDA3D]/10 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#7CDA3D]/20 relative overflow-hidden group/btn2">
